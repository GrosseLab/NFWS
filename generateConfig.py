...
with open(args.o, "w") as config:
	...
	'		"hg19": {\n'
	'			"BaseRecalibrator": [\n'
	'				"--known-sites", "/data/references/human/hg19/snp/dbsnp_138.hg19.vcf",\n'
	'				"--known-sites", "/data/references/human/hg19/snp/Mills_and_1000G_gold_standard.indels.hg19.sites.vcf",\n'
	'				"--known-sites", "/data/references/human/hg19/snp/1000G_phase1.indels.hg19.sites.vcf"\n'
	'			],\n'
	'			"HaplotypeCaller": [\n'
	...
	'		"hg38": {\n'
	'			"BaseRecalibrator": [\n'
	'				"--known-sites", "/data/references/human/hg38/snp/Homo_sapiens_assembly38.dbsnp138.vcf",\n'
	'				"--known-sites", "/data/references/human/hg38/snp/Mills_and_1000G_gold_standard.indels.hg38.vcf"\n'
	'			],\n'
	'			"HaplotypeCaller": [\n'
