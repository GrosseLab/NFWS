...
with open(args.o, "w") as config:
	...
	'			"-known", "/data/references/human/hg19/snp/Mills_and_1000G_gold_standard.indels.hg19.sites.vcf",\n'
	'			"-known", "/data/references/human/hg19/snp/1000G_phase1.indels.hg19.sites.vcf"\n'
	'		],\n'
	'		"IndelRealigner": [\n'
	'			"-known", "/data/references/human/hg19/snp/Mills_and_1000G_gold_standard.indels.hg19.sites.vcf",\n'
	'			"-known", "/data/references/human/hg19/snp/1000G_phase1.indels.hg19.sites.vcf"\n'
	'		],\n'
	'		"BaseRecalibrator": [\n'
	'			"-knownSites", "/data/references/human/hg19/snp/dbsnp_138.hg19.vcf",\n'
	'			"-knownSites", "/data/references/human/hg19/snp/Mills_and_1000G_gold_standard.indels.hg19.sites.vcf",\n'
	'			"-knownSites", "/data/references/human/hg19/snp/1000G_phase1.indels.hg19.sites.vcf"\n'
	'		],\n'
	'		"HaplotypeCaller": [\n'
	'			"-dbsnp", "/data/references/human/hg19/snp/dbsnp_138.hg19.vcf"\n'
	'		]\n'
	'	},\n'
	'	"hg38": {\n'
	'		"RealignerTargetCreator": [\n'
	'			"-known", "/data/references/human/hg38/snp/Mills_and_1000G_gold_standard.indels.hg38.vcf"\n'
	'		],\n'
	'		"IndelRealigner": [\n'
	'			"-known", "/data/references/human/hg38/snp/Mills_and_1000G_gold_standard.indels.hg38.vcf",\n'
	'			"-known", "/data/references/human/hg38/snp/1000G_phase1.snps.high_confidence.hg38.vcf"\n'
	'		],\n'
	'		"BaseRecalibrator": [\n'
	'			"-knownSites", "/data/references/human/hg38/snp/Homo_sapiens_assembly38.dbsnp138.vcf",\n'
	'			"-knownSites", "/data/references/human/hg38/snp/Mills_and_1000G_gold_standard.indels.hg38.vcf"\n'
	'		],\n'
	'		"HaplotypeCaller": [\n'
	'			"-dbsnp", "/data/references/human/hg38/snp/Homo_sapiens_assembly38.dbsnp138.vcf"\n'
	'		]\n'
	'	}\n'
	'}')
